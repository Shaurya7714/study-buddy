...
export default function ReviewPage() {
  ...
  if (loading) {
    return (
      <div style={{ minHeight: '100vh', backgroundColor: '#0a0a0f' }}>
        ...
        <p style={{ padding: '30px', color: '#f8fafc', fontWeight: 700, textAlign: 'center' }}>Loading Spaced Repetition Review...</p>
      </div>
    )
  }
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#0a0a0f' }}>
      ...
      <main style={{ padding: '30px', maxWidth: '650px', margin: '0 auto' }}>
        ...
        {dueQuestions.length === 0 ? (
          <div style={{ padding: '40px', backgroundColor: '#064e3b', border: '1px solid #10b981', borderRadius: '14px', textAlign: 'center' }}>
          ...
          <div style={{ padding: '40px', backgroundColor: '#1e3a8a', border: '1px solid #3b82f6', borderRadius: '14px', textAlign: 'center' }}>
